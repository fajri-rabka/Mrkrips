...
<head>
    ...
    <title>Panen Saham - Chart Crypto</title>
        ...
        <div class="container">
            <div class="row chart__containericon g-0">
                <div class="col-12 col-md-5 col-lg-5 col-xl-4 pe-4">
                    <div class="chart__iconbox1 ">
                        <div class="chart__headicon bg__1">
                ...
                <div class="col-md-7 col-xl-8">
                    <div class="chart__content">
                        <div class="box">
                            <img class="show1" src="img/chart-crypto.png" data-mfp-src="img/chart-crypto.png" alt="chart">
                        </div>
                    </div>
